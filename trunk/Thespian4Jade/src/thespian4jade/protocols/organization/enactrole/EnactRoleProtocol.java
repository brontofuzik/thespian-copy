...
public class EnactRoleProtocol extends Protocol {
    ...
    /**
     * Initializes a new instance of the EnactRoleProtocol class.
     * The 'Enact role' protocol is initiated by an ACL message with the REQUEST
     * performative.
     */
    public EnactRoleProtocol() {
    ...
    /**
     * Creates a new 'Enact role' protocol initiator party.
     * @param arguments the 'Enact role' protocol initiator party's contructor
     * arguments:
     *     1) name of the organization, and
     *     2) name of the role
     * @returns a new 'Enact role' protocol initiator party
     */
    @Override
    ...
    /**
     * Creates a new 'Enact role' protocol responder party.
     * @param message the ACL message to which the 'Enact role' protocol
     * responder party responds
     * @returns a new 'Enact role' protocol responder party
     */
    @Override
